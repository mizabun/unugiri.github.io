    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#new-order-modal"
                class="btn btn-primary shadow-md mr-2">Pesan Baru</a>
        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            ...
            <div class="grid grid-cols-12 gap-5 mt-5">
                <div class="col-span-12 sm:col-span-4 2xl:col-span-3 box p-5 cursor-pointer zoom-in">
                    ...
                    <div class="text-slate-500">5 Item</div>
                </div>
                <div class="col-span-12 sm:col-span-4 2xl:col-span-3 box bg-primary p-5 cursor-pointer zoom-in">
                    ...
                    <div class="text-white text-opacity-80 dark:text-slate-500">8 Item</div>
                </div>
                <div class="col-span-12 sm:col-span-4 2xl:col-span-3 box p-5 cursor-pointer zoom-in">
                    <div class="font-medium text-base">Pasta</div>
                    <div class="text-slate-500">4 Item</div>
                </div>
                <div class="col-span-12 sm:col-span-4 2xl:col-span-3 box p-5 cursor-pointer zoom-in">
                    <div class="font-medium text-base">Waffle</div>
                    <div class="text-slate-500">3 Item</div>
                </div>
                <div class="col-span-12 sm:col-span-4 2xl:col-span-3 box p-5 cursor-pointer zoom-in">
                    <div class="font-medium text-base">Snacks</div>
                    <div class="text-slate-500">8 Item</div>
                </div>
                <div class="col-span-12 sm:col-span-4 2xl:col-span-3 box p-5 cursor-pointer zoom-in">
                ...
                <div class="col-span-12 sm:col-span-4 2xl:col-span-3 box p-5 cursor-pointer zoom-in">
                    ...
                    <div class="text-slate-500">9 Item</div>
                </div>


                {{-- @foreach ($produk as $p)
                    <div class="col-span-12 sm:col-span-4 2xl:col-span-3 box p-5 cursor-pointer zoom-in">
                        <div class="font-medium text-base">{{ $p->kategori_produk }}</div>
                        <div class="text-slate-500">9 Item</div>
                    </div>
                @endforeach --}}
                ...
                @foreach ($produk as $produk)
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal"
                        ...
                        <div class="box rounded-md p-3 relative zoom-in">
                            ...
                            <div class="block font-medium text-center truncate mt-3">{{ $produk->nama_produk }}</div>
                        </div>
                    </a>
                @endforeach
            </div>
                ...
                <div id="ticket" class="tab-pane active" role="tabpanel" aria-labelledby="ticket-tab">
                    ...
                    <div class="box flex p-5 mt-5">
                        <input type="text" class="form-control py-3 px-4 w-full bg-slate-100 border-slate-200/60 pr-10"
                            placeholder="Guanakan Voucher...">
                        <button class="btn btn-primary ml-2">Apply</button>
                    </div>
                    <div class="box p-5 mt-5">
                        <div class="flex">
                            <div class="mr-auto">Subtotal</div>
                            <div class="font-medium">Rp. 100.000</div>
                        </div>
                        <div class="flex mt-4">
                            <div class="mr-auto">Diskon</div>
                            <div class="font-medium text-danger">Rp. 20.000</div>
                        </div>
                        {{-- <div class="flex mt-4">
                        ...
                        <div class="flex mt-4 pt-4 border-t border-slate-200/60 dark:border-darkmode-400">
                            ...
                            <div class="font-medium text-base">Rp. 80.000</div>
                        </div>
                    </div>
                    <div class="flex mt-5">
                        <button class="btn w-32 border-slate-300 dark:border-darkmode-400 text-slate-500">Hapus
                            Item</button>
