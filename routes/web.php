...
Route::middleware('auth')->group(function () {
    ...
    Route::controller(PageController::class)->group(function () {
        ...
        Route::get('catatan', 'catatan')->name('catatan');
        Route::get('log-out', 'logOut')->name('log-out');
        // Route::get('update', 'update')->name('update');
        Route::post('update-data', 'updateData')->name('update-data-list');
        ...
        Route::get('laporan-data-kinerja', 'laporanDataKinerja')->name('laporan-data-kinerja');
    ...
    // Route::post('update-data', [CrudController::class, 'up']);
    // Route::get('logout', [AuthController::class, 'logout'])->name('logout');
});
